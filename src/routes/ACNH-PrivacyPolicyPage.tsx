...
export default function PrivacyPolicyPage() {
  return (
    <div className="policy-wrapper">
      <h1 className="policy-title">ACNH-Vill-Finder</h1>
      <div className="policy-container">
        <strong>Privacy Policy</strong>{" "}
        <p>
          Tenzin Norden built the ACNH-Vill-Finder app as a Free app. This SERVICE is
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at ACNH-Vill-Finder unless
