...
export default function PrivacyPolicyPage() {
  return (
    <div className="policy-wrapper">
      <h1 className="policy-title">LstMkr</h1>
      <div className="policy-container">
        <strong>Privacy Policy</strong>{" "}
        <p>
          Tenzin Norden built the LstMkr app as a Free app. This
          SERVICE is provided by Tenzin Norden at no cost and is intended for
          use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at LstMkr unless
