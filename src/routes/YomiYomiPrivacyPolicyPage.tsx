...
export default function YomiYomiPrivacyPolicyPage() {
  return (
    <div className="policy-wrapper">
      <h1 className="policy-title">YomiYomi</h1>
      <div className="policy-container">
        <strong>Privacy Policy</strong>{" "}
        <p>
          Tenzin Norden built the YomiYomi app as a Free app. This SERVICE is
          provided by Tenzin Norden at no cost and is intended for use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at YomiYomi unless otherwise
        ...
        <p>
          ...
          not hesitate to contact me at nordentenzinwork@gmail.com.
        </p>{" "}
        <p>
