...
export default function PrivacyPolicyPage() {
  return (
    <div className="policy-wrapper">
      <h1 className="policy-title">PicPackr</h1>
      <div className="policy-container">
        <strong>Privacy Policy</strong>{" "}
        <p>
          Tenzin Norden built the PicPackr app as a Free app. This SERVICE is
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at PicPackr unless
