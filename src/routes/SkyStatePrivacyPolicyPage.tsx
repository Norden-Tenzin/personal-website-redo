...
export default function SkyStatePrivacyPolicyPage() {
  return (
    <div className="policy-wrapper">
      <h1 className="policy-title">SkyState</h1>
      <div className="policy-container">
        <strong>Privacy Policy</strong>{" "}
        <p>
          Tenzin Norden built the SkyState app as a Free app. This SERVICE is
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at SkyState unless
